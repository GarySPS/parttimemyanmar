    ...
    <nav className="sticky top-0 z-50 w-full bg-[#0f4c5c] px-4 py-3 md:px-8 flex justify-between items-center shadow-lg shadow-[#0f4c5c]/20 border-b border-white/10">
      <div className="flex items-center">
        ...
        {user ? (
          ...
          <Link href="/login" className="px-6 py-2.5 bg-[#e3b23c] text-[#0f4c5c] rounded-xl text-sm font-extrabold shadow-lg shadow-[#e3b23c]/20 hover:bg-[#f0c254] hover:-translate-y-0.5 active:scale-[0.97] active:translate-y-0 active:shadow-sm transition-all">
            {t.login}
          </Link>
        )}
      </div>
